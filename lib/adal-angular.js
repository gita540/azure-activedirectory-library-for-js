                    ...
                    if (_adal.isCallback(hash)) {
                        ...
                        if (requestInfo.stateMatch) {
                            if (requestInfo.requestType === _adal.REQUEST_TYPE.RENEW_TOKEN) {
                                ...
                                if (!_adal.popUp && _adal.config.navigateToLoginRequestUrl) {
                                    ...
                                    if ($location.$$html5) {
                                        ...
                                        var oldUrlPath = oldUrl.substring(oldUrl.indexOf('#') + 1);
                                        index == -1 || _adal.isCallback('#' + oldUrlPath) ? $location.path('') : $location.path(oldUrlPath);
                                    }
                                }
                            }
                        }
