...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext = function (config) {
        ...
        if (typeof this.config.navigateToLoginRequestUrl === 'undefined')
    ...
    AuthenticationContext.prototype.handleWindowCallback = function (hash) {
        ...
        if (this.isCallback(hash)) {
            ...
            if (!this.popUp) {
                ...
                if (this.config.navigateToLoginRequestUrl && window.location.href.indexOf(this._getItem(this.CONSTANTS.STORAGE.LOGIN_REQUEST)) === -1)
